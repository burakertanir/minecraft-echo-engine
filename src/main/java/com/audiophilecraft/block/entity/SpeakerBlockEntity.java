...
public class SpeakerBlockEntity extends BlockEntity implements ExtendedScreenHandlerFactory {
    ...
    public void autoConfigureShift(net.minecraft.world.World world, BlockPos pos) {
        // Disabled by user request. Default remains 0.
    }
    ...
    public void readNbt(NbtCompound nbt) {
        ...
        com.audiophilecraft.registry.SpeakerRegistry.registerSpeaker(pos);
    }
