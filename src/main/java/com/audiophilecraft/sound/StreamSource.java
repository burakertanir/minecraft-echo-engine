...
public class StreamSource {
    ...
    private boolean reflectionLogDone = false; // Debug: one-time log for early reflections
    ...
    private float smoothedInputGain = 1.0f;
    ...
    public boolean update(net.minecraft.world.World world, Vec3d listenerPos, double timeSeconds) {
        if (!isValid)
            return false;
    ...
    private void updatePhysics(net.minecraft.world.World world, Vec3d listenerPos, double distance, double dx,
        ...
        float manualRolloff = 1.0f; // Not used in Linear model directly, but kept for reference
