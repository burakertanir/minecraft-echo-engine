...
public class StreamDSPPipeline {
    ...
    public StreamDSPPipeline(String speakerType, float sampleRate) {
        this.speakerType = speakerType;

        if ("sub".equals(speakerType)) {
            crossoverFilter1 = new AudioDSP.BiquadFilter(AudioDSP.FilterType.LOW_PASS, sampleRate, 120.0f, 0.707f, 0.0f);
            crossoverFilter2 = null;
            eqFrequencies = new float[] { 30f, 50f, 70f, 90f, 110f };
        } else if ("mid".equals(speakerType)) {
            crossoverFilter1 = new AudioDSP.BiquadFilter(AudioDSP.FilterType.HIGH_PASS, sampleRate, 120.0f, 0.707f, 0.0f);
            crossoverFilter2 = new AudioDSP.BiquadFilter(AudioDSP.FilterType.LOW_PASS, sampleRate, 4000.0f, 0.707f, 0.0f);
