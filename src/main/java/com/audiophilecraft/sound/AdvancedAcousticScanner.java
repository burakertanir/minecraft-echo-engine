...
public class AdvancedAcousticScanner {
    ...
    public static java.util.List<Vec3d> lastPointCloud = new java.util.ArrayList<>();
    public static java.util.Set<net.minecraft.util.math.BlockPos> lastVenueBlocks = new java.util.HashSet<>();
    public static java.util.List<net.minecraft.util.math.BlockPos> lastSpeakers = new java.util.ArrayList<>();
